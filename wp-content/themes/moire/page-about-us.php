  ...
  <div class="about_content_block mission_block">
    ...
    <div class="mission_content_wrap">
      ...
      <div class="mission_content">
        moireは、</br>
        「社会をよくする事を目標としている活動」を総じて<strong>‘社会活動’</strong>と捉えています。</br>
        そして社会活動がより活発になることで、</br>
        世の中は少しづつ今より良い方向へと進んで行くと信じています。</br>
        だから、社会活動がより活発になることを目標としています。
      </div>
      ...
      <div class="mission_content">
        様々な特色を持った社会活動をもっと知ってもらう。</br>
        社会的な活動に対する固い・面白くないというイメージを変え、参加の敷居を下げる。</br>
        </br>
        この二つを実現すれば、自ずと社会活動は活発になると考えています。</br>
        そしてそのために、moireはイベントとHP運営行っています。
      </div>
    </div>
  </div>
