...
<head>
  ...
  <style>
  .content-effect-wrapper{width:100%;height:100%;overflow:hidden;position:relative}.about_content_block{width:100%;background:#ffffff;text-align:center;font-size:17px;padding:50px 10px}.about_content_block h1{font-family:'klee',sans-serif}.about_sub_title{width:550px;margin:0 auto;border-bottom:solid #2fcbb2}.about_sub_title h2{font-weight:bold;margin:0}@media screen and (max-width:550px){.about_content_block{padding:10px}.about_sub_title{width:96%}}.mission_content_wrap{width:650px;margin:0 auto}.mission_sub_title--1 h2{font-size:22px}.mission_sub_title--2 h2{font-size:20px}.mission_content{margin:30px 0 50px;line-height:35px;text-align:left}@media screen and (max-width:650px){.mission_content_wrap{width:100%;padding:0 20px}}
  </style>
